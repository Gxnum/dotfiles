...
# alias for grep and ls and cd
alias grep='grep --color=auto'
alias ls='ls -aS --color=auto'
alias sd='cd $(find . -type d -print | fzf)'
# alias for Neovim
alias v='nvim'
alias vzsh='v ~/.zshrc'
alias vhypr='v ~/.config/hypr/hyprland.conf'
alias vwaycon='v ~/.config/waybar/config'
alias vwaycss='v ~/.config/waybar/style.css'
alias venv='sudo nvim /etc/environment'
# alias for verbose cp, mv, rm
alias mv='mv -v'
alias cp='cp -vr'
alias rm='rm -vr -rf'
# alias for killall
alias kt='killall teams-for-linux'
